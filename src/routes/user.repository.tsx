  ...
  head: () => ({
    meta: [
      { title: "Polar Knowledge Repository — POLARIS" },
      {
        name: "description",
        content:
          "Search and filter polar science research papers, reports, articles, datasets and educational resources across the Arctic and Antarctic.",
      },
      { property: "og:title", content: "Polar Knowledge Repository — POLARIS" },
      {
        property: "og:description",
        content: "Search the integrated polar science knowledge repository.",
      },
