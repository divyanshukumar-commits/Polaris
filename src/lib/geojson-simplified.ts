...
export const worldGeoData = {
  continents: [
    ...
    // Asia
    {
      name: "Asia",
      points: [
        [26, 71], [26, -10], [160, -10], [160, 71], [26, 71],
      ],
    },
    // Australia
    {
  ...
  cities: [
    ...
    { name: "Mumbai", lat: 19.0760, lon: 72.8855 },
  ],
