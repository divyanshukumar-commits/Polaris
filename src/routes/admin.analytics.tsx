...
export const Route = createFileRoute("/admin/analytics")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Platform traffic metrics, research paper downloads, topic interest, and geographic dissemination.",
      },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatCard icon={<Users size={16} />} label="Total Portal Visitors" value={87200} suffix="+" />
        <StatCard icon={<Download size={16} />} label="Research & Dataset Downloads" value={32250} suffix="+" />
        <StatCard icon={<Eye size={16} />} label="Media Gallery Impressions" value={142800} suffix="+" />
        <StatCard icon={<Activity size={16} />} label="Outreach Quiz Completions" value={5410} suffix="+" />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <div className="glass rounded-3xl p-6 glow-soft border border-border/80 lg:col-span-6">
          ...
          <div className="h-64 w-full">
            {mounted ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topicDistribution} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
