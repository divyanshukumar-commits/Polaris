...
import { SubmitResearchModal } from "@/components/polaris/submit-research-modal";
  ...
  head: () => ({
    meta: [
      { title: "Researcher Dashboard — POLARIS" },
      {
        name: "description",
        content:
          "Manage your polar research papers, dataset submissions, peer-review statuses, and station telemetry.",
      },
...
function ResearcherDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-primary-foreground shadow-md transition-opacity hover:opacity-90 glow-primary cursor-pointer"
          >
      ...
      <section>
        <SectionTitle
          title="Earth Observation Operations"
          action={
            <span className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
              Field missions & research locations
            </span>
          }
        />
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Manage your submitted manuscripts, datasets, and track peer review status in
                real-time.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                High-resolution field photography, mission video logs, telemetry imagery, and
                submission hub.
              </p>
            </div>
            <div className="mt-4 flex items-center text-xs font-semibold text-primary">
              Explore Media <ArrowRight size={14} className="ml-1" />
            </div>
          </Link>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-primary/20 bg-gradient-to-r from-primary/10 via-background to-secondary/30 p-6">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 px-3 py-1 font-mono text-[10px] font-bold text-emerald-400">
            <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" /> All Stations
            Online
          </span>
        </div>
      ...
      <SubmitResearchModal
        ...
        onSuccess={(item) => setSelectedItem(item)}
      />
