...
function TimelinePage() {
  ...
  const timelinePosition =
    timelinePeriods.length > 1 ? (activeIdx / (timelinePeriods.length - 1)) * 100 : 0;
  ...
  const indianMilestones = [
    {
      ...
      desc: "Led by Dr. S. Z. Qasim on MV Polar Circle.",
    },
    {
      year: 1983,
      title: "Dakshin Gangotri Station",
      desc: "India's 1st permanent Antarctic base built in 45 days.",
    },
    {
      year: 1989,
      title: "Maitri Station Commissioned",
      desc: "Year-round station in the rocky Schirmacher Oasis.",
    },
    {
      year: 1998,
      title: "NCPOR Established",
      desc: "National Centre for Polar and Ocean Research founded in Goa.",
    },
    {
      year: 2008,
      title: "Himadri Arctic Base",
      desc: "India's permanent Arctic station at Ny-Ålesund, Svalbard.",
    },
    {
      year: 2012,
      title: "Bharati Station Commissioned",
      desc: "3rd state-of-the-art green Antarctic station in Larsemann Hills.",
    },
    {
      year: 2014,
      title: "IndARC Mooring Deployed",
      desc: "Underwater observatory deployed at 192m in Kongsfjorden.",
    },
    {
      year: 2026,
      title: "POLARIS Portal Launch",
      desc: "Integrated national polar knowledge and outreach platform.",
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        >
          <Flag size={14} />{" "}
          {filterIndianOnly ? "Showing Indian Milestones" : "Highlight Indian Stations"}
        </button>
      </PageHeader>
