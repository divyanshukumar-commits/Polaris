  ...
  head: () => ({
    meta: [
      { title: "Interactive Expedition Map — POLARIS" },
      {
        name: "description",
        content:
          "Track active, upcoming and completed polar expeditions on an interactive Arctic and Antarctic map.",
      },
      { property: "og:title", content: "Interactive Expedition Map — POLARIS" },
      {
        property: "og:description",
        content: "Explore polar expeditions on the interactive polar map.",
      },
