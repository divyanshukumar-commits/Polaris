...
export const Route = createFileRoute("/admin/content")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Moderate and approve research papers, scientific datasets, and metadata submissions.",
      },
...
function ContentModerationPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        {filtered.length === 0 && (
          <div className="glass rounded-2xl p-12 text-center text-muted-foreground border border-border">
            ...
            <h4 className="font-display text-sm font-semibold text-foreground">No submissions found</h4>
      ...
      {activeItem && (
        <ResearchDetailModal item={activeItem} onClose={() => setActiveItem(null)} />
      )}
    </div>
  );
}
