...
export const Route = createFileRoute("/researcher/expeditions")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Track field expedition logs, scientific payloads, and telemetry from Arctic and Antarctic research bases.",
      },
...
function ResearcherExpeditionsPage() {
  const [selectedExp, setSelectedExp] = useState<Expedition | null>(expeditions[0]);
        ...
        <div className="lg:col-span-5">
          {selectedExp ? (
            ...
            >
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">{selectedExp.summary}</p>
              ...
              <div className="space-y-2 pt-2">
                ...
                <ul className="space-y-1.5 pl-1">
                  {(selectedExp.objectives ?? (selectedExp.objective ? [selectedExp.objective] : [])).map((obj, i) => (
              ...
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs text-muted-foreground">
                <span className="font-mono text-[10px]">Team: {selectedExp.members} scientists</span>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={idx} className="glass rounded-2xl p-5 glow-soft border border-border">
              ...
              <h4 className="mt-2 font-display text-sm font-bold text-foreground">{item.mission}</h4>
